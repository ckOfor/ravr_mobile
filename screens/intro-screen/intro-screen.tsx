...
import {
  getWeekendToursAsync,
  getDiscoverToursAsync,
  setSelectedTours,
  searchTextToursAsync,
  searchAmountToursAsync,
  introSearchTextToursAsync, introSearchAmountToursAsync
} from "../../redux/tour";
...
class Intro extends React.Component<NavigationScreenProps & Props> {
            ...
            
            {
              weekendTours[0].id !== null && (
                <WeekendScreen
                  ...
                  viewTours={() => navigation.navigate('introViewTour')}
                  page={'landing'}
                  {...this.props}
                />
              )
...
const mapDispatchToProps = (dispatch: Dispatch<any>): DispatchProps => ({
  ...
  searchTextToursAsync: (searchKey: string) => dispatch(introSearchTextToursAsync(searchKey)),
  searchAmountToursAsync: (amount: number) => dispatch(introSearchAmountToursAsync(amount)),
})
...
export const IntroScreen = connect<StateProps>(
  mapStateToProps,
  mapDispatchToProps
)(Intro)
